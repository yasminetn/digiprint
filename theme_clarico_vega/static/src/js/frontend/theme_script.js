            ...
            if($('.product_details_sticky').length){
                if($('div#product_details a#add_to_cart').length){
                    ...
                    if ($(window).width() <= 767){
                        ...
                        console.log('$(".relative_position_cart").offset() ddddddddddd', $(".relative_position_cart").offset())
                        console.log('$("main").offset() ddddddddddd', $("main").offset())

                        console.log('scroll ddddddddddd', scroll)
